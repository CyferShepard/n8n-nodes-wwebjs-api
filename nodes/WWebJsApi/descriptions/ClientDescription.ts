...
export const clientOperations: INodeProperties[] = [
  {
    ...
    options: [
      ...
      { name: "Get Contacts", value: "getContacts", description: "Get all current contacts", action: "Get all contacts" },
      {
        name: "Get Number ID",
        value: "getNumberId",
        description: "Get the registered WhatsApp ID for a number",
        action: "Get number ID",
      },
      {
        name: "Get Profile Picture URL",
        value: "getProfilePicUrl",
        description: "Get the profile picture URL of a contact",
        action: "Get profile picture URL",
      },
      {
      ...
      { name: "Pin Chat", value: "pinChat", description: "Pin a chat", action: "Pin a chat" },
      {
        ...
        description: "Search for messages across chats",
      ...
      { name: "Send Seen", value: "sendSeen", description: "Mark a chat as seen", action: "Send seen status" },
      {
        name: "Set Status",
        value: "setStatus",
        description: "Set the current user status message",
    ...
    options: [
      {
        ...
        type: "string",
        default: "",
        description: "Caption for the media message (ignored for text messages)",
      },
      {
